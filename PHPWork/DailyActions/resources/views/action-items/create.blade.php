...
<div class="container">
  ...
  <form action="{{ url('action-items') }}" method="post">
    ...
    <div class="form-group">
      <div class=row>
          <label class="col-sm-3" for="index1text">{{__('actionitems.Index1Text') }}</label>
          <input class="col-sm-9" id="index1text" type="text" class="form-control" name="index1text" required autofocus>
      </div>
    </div>
    <div class="form-group">
      <label for="index2text">{{__('actionitems.Index2Text') }}</label>
      <input id="index2use" type="checkbox" class="" name="index2use" value="1" >
      <input id="index2text" type="text" class="form-control" name="index2text" >
    </div>
    <div class="form-group">
